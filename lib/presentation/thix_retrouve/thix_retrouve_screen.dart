...
// ============================================================================
// COULEURS SPÉCIFIQUES "THIX RETROUVE" (Thème Violet Profond)
// ============================================================================
class _RetrouveColors {
  static const Color background = Color(0xFF150B24); // Violet très sombre/premium
  static const Color glow = ThixPolicy.domainMedia; // Violet vibrant de la charte
}
...
class _ThixRetrouveScreenState extends ConsumerState<ThixRetrouveScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          // ─── BACKGROUND GLOW (Effet de lumière Violette) ───
          Positioned(
            top: -80, right: -50,
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                color: _RetrouveColors.glow.withOpacity(0.2),
                boxShadow: [BoxShadow(color: _RetrouveColors.glow.withOpacity(0.25), blurRadius: 120, spreadRadius: 100)]
              )
            ),
          ),
          Positioned(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [BoxShadow(color: ThixPolicy.primary.withOpacity(0.15), blurRadius: 100, spreadRadius: 80)]
              )
            ),
          ),
                            ...
                            children: [
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  border: Border.all(color: _RetrouveColors.glow.withOpacity(0.5)),
                                ),
                              ...
                              child: Row(
                                children: [
                                  Container(
                                    ...
                                    decoration: BoxDecoration(color: ThixPolicy.primary.withOpacity(0.2), shape: BoxShape.circle),
                                    child: const Icon(Icons.location_on_rounded, color: ThixPolicy.primary, size: 20),
                                  ),
                                  const SizedBox(width: ThixPolicy.s12),
                                  Expanded(
                                    child: Column(

...
class ExecutionService {
  ...
  Future<ExecutionProject> refreshHealth(String projectCode) async {
    ...
    try {
      ...
      treasury = snapshot.treasury; burn = snapshot.burnRate; runway = snapshot.runwayMonths;
    } catch(_){}
    ...
    final project = ExecutionProject(
      ...
      healthDimensions: dimensions, treasury: treasury, burnRate: burn, runwayMonths: runway, mrr: 5670,

...
/// - Menu ⋮ sur les vidéos du propriétaire (isOwner)
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        flexibleSpace: ClipRRect(
          child: BackdropFilter(
            filter: ImageFilter.blur(
              sigmaX: MediaConfig.glassBlur,
              sigmaY: MediaConfig.glassBlur,
            ),
            child: Container(
        ...
        title: profileAsync.whenOrNull(
            ...
            Text(
              _safeTr(l10n, 'nav_profile', 'Profil'),
              style: const TextStyle(
                color: MediaLightPalette.textPrimary,
                fontSize: 16,
                fontWeight: FontWeight.w800,
        ...
        loading: () => Center(
          child: Column(
            ...
            children: [
              ...
              Text(
                _safeTr(l10n, 'profile_loading', 'Chargement du profil...'),
                style: const TextStyle(
        ...
        data: (bundle) {
          if (bundle.hasError || bundle.profile == null) {
            return _buildNotFoundState(
              l10n,
              bundle.error ??
                  _safeTr(l10n, 'profile_not_found', 'Profil introuvable'),
            );
          }
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                backgroundColor: MediaLightPalette.textPrimary,
                foregroundColor: Colors.white,
                elevation: 0,
              ),
    ...
    return RefreshIndicator(
      ...
      child: CustomScrollView(
        ...
        slivers: [
                      ...
                      SnackBar(
                        content: Text(
                          _safeTr(
                            l10n,
                            'profile_edit_soon',
                            'L\'édition du profil sera bientôt disponible',
                          ),
                        ),
          ...
          // ✅ isOwner transmis → menu ⋮ (modifier / privé / supprimer)
          ProfileVideosGrid(

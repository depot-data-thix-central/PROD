...
//
// Langues supportées (7) — synchronisées avec app_localizations.dart :
...
class I18nService {
  ...
  /// Traduction simple ou paramétrée via [AppLocalizations.t].
  ...
  /// Traduction pour les pluriels via [AppLocalizations.plural].

...
class AppLocalizationsFr extends AppLocalizations {
  ...
  @override String common_messages(int count) => count == 0 ? 'Aucun message' : (count == 1 ? '1 message' : '$count messages');
  ...
  @override String edu_coming_soon(String category) => 'Nouveaux cours en $category bientôt disponibles';
  ...
  // ============================================================================
  // RECHERCHE (DISPARITIONS / AVIS DE RECHERCHE)
  // ============================================================================
  ...
  @override String admin_events_delete_desc(String title) => 'Voulez-vous supprimer $title ? Action irréversible.';
  ...
  @override String admin_seat_max_limit(int count) => 'Maximum $count sièges';

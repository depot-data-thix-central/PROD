...
class AppLocalizationsEn extends AppLocalizations {
  ...
  @override
  String common_items(int count) => count == 0 ? 'No items' : (count == 1 ? '1 item' : '$count items');
  @override
  String common_contacts(int count) => count == 0 ? 'No contacts' : (count == 1 ? '1 contact' : '$count contacts');
  @override
  String common_messages(int count) => count == 0 ? 'No messages' : (count == 1 ? '1 message' : '$count messages');
  @override
  String common_days(int count) => count == 0 ? '0 days' : (count == 1 ? '1 day' : '$count days');
  @override
  String common_hours(int count) => count == 0 ? '0 hours' : (count == 1 ? '1 hour' : '$count hours');
  @override
  String common_minutes(int count) => count == 0 ? '0 minutes' : (count == 1 ? '1 minute' : '$count minutes');
  ...
  @override String get source_aria_label => 'Source of information';
  ...
  @override String get auth_email => 'Email';
  ...
  @override String get auth_logout_confirm => 'Are you sure you want to logout?';
  ...
  @override String get auth_password_too_short => 'Password too short (8 characters minimum)';
  ...
  @override String get auth_session_expired => 'Session expired, please login again';
  ...
  @override String get onboarding_step_1_title => 'Connection';
  ...
  @override String get onboarding_step_3_desc => 'Alert your rescuers in 2 seconds';
  @override String get onboarding_get_started => 'Get started';
  @override String get onboarding_skip => 'Skip introduction';
  ...
  @override String get login_identifier_label => 'Username';
  ...
  @override String get login_error_no_account => 'No account found with this information.';
  @override String get login_error_mfa_required => 'Two-factor authentication required.';

  @override String get auth_error_identifier_required => 'Username is required';
  ...
  @override String get auth_error_network => 'Network connection error. Please check your internet.';
  ...
  @override String get auth_error_resend_otp_failed => 'Failed to resend OTP';
  ...
  @override String get auth_info_otp_sent => 'Verification code sent';

  // ============================================================================
  // REGISTRATION
  // ============================================================================
  @override String get reg_step1_title => 'Your profile';
  @override String get reg_step1_subtitle => 'Let\'s start with basic information';
  ...
  @override String get reg_confirm_password_hint => 'Re-enter your password';
  ...
  @override String get cert_tier_ladder => 'Current tier under review';
  ...
  @override String get chatlist_create_new => 'Create new discussion';
  ...
  @override
  String chat_members(int count) => count == 1 ? '1 member' : '$count members';
  ...
  @override String get conv_group_rpc_required => 'Creating a group requires a server call';
  @override String get conv_page_title => 'New discussion';
  @override
  String conv_start(int count) => 'Start ($count)';
  @override String get conv_search_label => 'Search for a user';
  ...
  @override String get requests_reject_message => 'Are you sure you want to reject this connection request? This action is irreversible.';
  ...
  @override String get network_explore_title => 'Explore THIX network';
  ...
  @override String get community_create_title => 'Create community';
  ...
  @override String get profile_no_bio => 'No biography available at the moment.';
  ...
  @override String get profile_no_private_media => 'No private media at the moment';
  ...
  @override String get settings_section_messages => 'Messages and data';
  ...
  @override String get settings_download_mobile => 'Wi-Fi and mobile data';
  ...
  @override String get sos_button_hint => 'Press for 2 seconds to activate';
  @override String get sos_button_tooltip => 'Hold for 2 seconds';
  @override String get sos_trigger_button => 'Activate SOS';
  @override String get sos_trigger_timeout => 'Timeout. Please try again.';
  @override String get sos_trigger_error => 'Failed to activate SOS';
  ...
  @override String get sos_cancel_failed => 'Cancellation failed';
  ...
  @override String get sos_history_error => 'Unable to load history';
  ...
  @override String get sos_add_rescuer_info => 'Enter the rescuer\'s THIX ID. Name and photo will be retrieved automatically.';
  ...
  @override String get edu_auth_required => 'Login to view your courses';
  @override String get edu_login_required => 'Login to view your courses';
  ...
  @override String get edu_ready_to_learn => 'Ready to develop your skills?';
  ...
  @override String get edu_see_all => 'View catalog';

  @override
  String edu_coming_soon(String category) => 'New courses in $category coming soon';
  @override String get edu_coming_soon_cat => 'New courses coming soon here';
  @override String get edu_locked_course => 'Coming soon! (Expected to open soon)';
  ...
  @override String get edu_awaited_locked_msg => 'Coming soon! (Expected to open soon)';

  @override String get edu_thix_academy => 'THIX Academy';
  @override String get edu_scheduled_soon => 'Scheduled: Soon';
  ...
  @override
  String edu_search_no_results(String query) => 'No results for "$query"';

  @override String get edu_shelf => 'Shelf';
  @override String get edu_books => 'books';
  @override String get edu_all => 'All';
  @override
  String edu_shelf_info(String code, int count) => 'Shelf $code · $count books';
  @override String get edu_free => 'Free';
  @override String get edu_deleted_in => 'Deleted in';
  @override
  String edu_expires_in(String countdown) => 'Expires in $countdown';
  ...
  @override String get edu_mentorship => 'Networking and mentorship';
  ...
  @override String get jobs_search => 'Search for a job';
  ...
  @override String get jobs_no_experience => 'No experience required';
  ...
  @override String get money_add_recipient => 'Add recipient';
  ...
  @override String get event_sold_out_msg => 'All spots are currently booked. Join the waitlist to be notified if spots open up.';
  @override String get event_join_queue_confirm => 'Do you want to join the waitlist?';
  ...
  @override
  String event_remaining_seats(String count) => '$count seats remaining';
  ...
  @override
  String event_numbered_seats(String count) => '$count numbered seats';
  ...
  @override String get events_buy_ticket => 'Buy ticket';
  ...
  @override String get events_seats_available => 'Seats available';
  ...
  @override String get ticket_pin_incorrect => 'Incorrect code';
  ...
  @override String get tickets_load_error => 'Unable to load your tickets';
  @override
  String tickets_quantity(int count) => count == 0 ? 'No tickets' : (count == 1 ? '1 ticket' : '$count tickets');
  ...
  @override String get info_title => 'Info';
  ...
  @override String get payment_card => 'Bank card';
  ...
  @override String get search_subtitle => 'Missing persons and wanted notices';
  @override String get search_person_missing => 'Missing person';
  @override String get search_person_wanted => 'Official wanted notice';
  @override String get search_report_missing => 'Report missing';
  ...
  @override String get nearby_legend_missing => 'Missing';
  @override String get nearby_legend_official => 'Official notice';
  @override String get nearby_legend_report => 'Report';
  @override String get nearby_location_required => 'Enable location';
  @override String get nearby_location_subtitle => 'View alerts around you';

  // ============================================================================
  // ADMIN
  // ============================================================================
  @override String get admin_title => 'THIX Administration';
  @override String get admin_dev_open => 'Development open';
  ...
  @override
  String admin_events_delete_desc(String title) => 'Do you want to delete $title? This action is irreversible.';
  ...
  @override String get admin_limits_info_desc => 'These limits are applied and verified directly by SQL functions (Edge Functions) in real-time to prevent any race condition (fraud).';
  ...
  @override String get admin_action_seats_sub => 'Batch 200';
  ...
  @override String get admin_bookings_empty => 'No bookings';
  @override String get admin_bookings_unknown_date => 'Unknown date';
  @override
  String admin_bookings_places(int count) => '$count seats';
  ...
  @override
  String admin_queue_title(int count) => 'Queue • Real-time ($count)';
  @override String get admin_queue_realtime_desc => 'Real-time active • Auto-refresh when users join';
  @override String get admin_queue_empty => 'No waiting';
  @override String get admin_queue_event_fallback => 'Event';
  @override
  String admin_queue_item_meta(String userId, int qty, String status) => 'User: $userId • $qty seats • $status';
  ...
  @override String get admin_queue_places => 'Seats';
  ...
  @override String get admin_analytics_revenue_7d => 'Revenue 7 days';
  @override String get admin_analytics_no_data => 'No data';
  @override String get admin_analytics_error => 'Unable to load statistics';
  ...
  @override String get admin_event_cover => 'Cover';
  ...
  @override String get admin_event_add_end => 'Add';
  ...
  @override
  String admin_event_dialog_price(String currency) => 'Price ($currency)';
  ...
  @override String get admin_event_err_min_tier => 'At least one tier required';
  @override String get admin_event_success => 'Event saved';
  ...
  @override String get admin_seat_page_title => 'Seat map and pricing';
  @override String get admin_seat_target_event => 'Target event';
  @override String get admin_seat_select_event => 'Select event';
  @override
  String admin_seat_max_limit(int count) => 'Maximum $count seats';
  @override
  String admin_seat_generated(int count) => '$count seats generated';
  @override String get admin_seat_load_error => 'Unable to load seats';
  @override String get admin_seat_pricing_title => 'Dynamic pricing';
  @override String get admin_seat_layout_title => 'Shape and layout';
  ...
  @override
  String admin_seat_generate_btn(int count) => 'Generate $count seats';
  @override String get admin_seat_preview => 'Current map preview';
  ...
  @override String get error_location_unavailable => 'Location unavailable';
  @override String get error_network => 'Network error';
  @override String get error_timeout => 'Timeout';
  ...
  @override
  String common_minutes_ago(int count) => count == 1 ? '1 minute ago' : '$count minutes ago';
  @override
  String common_hours_ago(int count) => count == 1 ? '1 hour ago' : '$count hours ago';
  @override
  String common_days_ago(int count) => count == 1 ? '1 day ago' : '$count days ago';
  @override
  String common_seconds_ago(int count) => count == 1 ? '1 second ago' : '$count seconds ago';
  @override
  String common_weeks_ago(int count) => count == 1 ? '1 week ago' : '$count weeks ago';
  @override
  String common_months_ago(int count) => count == 1 ? '1 month ago' : '$count months ago';
  @override
  String common_years_ago(int count) => count == 1 ? '1 year ago' : '$count years ago';
  @override
  String common_in_minutes(int count) => count == 1 ? 'In 1 minute' : 'In $count minutes';
  @override
  String common_in_hours(int count) => count == 1 ? 'In 1 hour' : 'In $count hours';
  @override
  String common_in_days(int count) => count == 1 ? 'In 1 day' : 'In $count days';

  // ============================================================================
  // LIVE & IA
  // ============================================================================
  @override String get live_leave_btn => 'Leave live';
  @override String get live_chat_empty => 'Be the first to comment!';
  @override String get live_chat_hint => 'Send a message…';
  @override String get live_like => 'Like';
  @override String get live_leaving => 'You left the live';
  ...
  @override String get insight_confidence_label => 'Confidence level';
  ...
  @override String get insight_generated_by => 'Generated by AI';
  @override String get insight_disclaimer => 'This is an AI-generated analysis. Please verify the information.';
